Feature: Validate get correct final price
  ...
  Scenario: Request price for 16:00 on day 16 and product 35455 and brand ZARA
    ...
    Then I validate if the price is correct for "2020-06-16-21.00.00" on product "35455" and brand "ZARA" with values 38.95 for priceValue,4 for priceList, "2020-06-15-16.00.00" for startDate, and "2020-12-3123.59.59" for endDate
